...
from typing import Tuple, Optional, Dict, List, Generator, Any, TypedDict
...
class ErrorManager:
    ...
    async def bot_on_error(self, *args, **kwargs):
    ...
    async def add_error(self, *, error: BaseException, ctx: Optional[commands.Context] = None) -> None:
        """|coro|
        ...
        packet: TracebackData = {"time": (ctx and ctx.message.created_at) or discord.utils.utcnow(), "exception": error}  # type: ignore
